    ...
    methods: {
      ...
      peticion: function(){
        axios.post(this.urlpeticion, {
            estatus: 1,
            municipios_id_municipio: 2,
            carreras_id_carrera: 3
            /*municipios_id_municipio: this.municipios.id_municipio,
            carreras_id_carrera: this.carreras.carreras_id_carrera*/
      })
